...
;  ca65 -l 6502-functional-test.lst 6502-functional-test.ca65
;  ld65 6502-functional-test.o -o 6502-functional-test.bin \
;   -m 6502-functional-test.map -C example.cfg
...
ccs4:       iny
            bne ccs5
            inx             ;opcode_advance RAM high address
            stx zpt+1
            cpx #ram_top
            bne ccs5
